...
const TimelineItem = ({ item, index }) => {
  ...
  return (
    <motion.div
      ...
      className="grid grid-cols-1 md:grid-cols-[200px_1fr] gap-6 md:gap-12 py-10 border-b border-[#fffff0]/20"
    >
...
export const Experience = () => {
  ...
  return (
    <section id="experiencia" className="px-10 md:px-16 py-14 border-t border-[#fffff0]/20">
