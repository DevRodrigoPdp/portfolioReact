...
export const Education = () => {
  return (
    <section id="formacion" className="py-16 scroll-mt-20 text-[#F5F5F5]">
          ...
          {education.map((edu, index) => (
            ...
            >
              <div className="flex justify-between items-start mb-2">
                <div>
                  <h3 className="text-xl font-semibold text-[#00ffae]">{edu.title}</h3>
                  <p className="text-sm text-[#A3A3A3]">
                    {edu.center} · {edu.period}
                  </p>
                </div>
              </div>
              <p className="text-[#D4D4D4] mb-4">{edu.description}</p>
